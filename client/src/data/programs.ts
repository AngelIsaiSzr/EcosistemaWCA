...
// Datos iniciales de los programas para la aplicación
export const initialPrograms: InsertCourse[] = [
  ...
  },
  {
    ...
    description: "Análisis de datos, visualización, machine learning y proyectos reales con Python y sus bibliotecas. Este programa cubre todo lo que necesitas para convertirte en un científico de datos: análisis exploratorio, preprocesamiento de datos, creación de modelos predictivos, evaluación de modelos y despliegue. Trabajarás con bibliotecas como NumPy, Pandas, Matplotlib, scikit-learn y TensorFlow en proyectos del mundo real.",
...
// Módulos para el programa de Desarrollo Web
export const webDevModules = [
  { courseId: 1, title: "Introducción a la Computación", description: "Aprende los conceptos básicos de la computación. Incluye historia de la computación, hardware y software.", duration: 2, order: 1, difficulty: "Easy", instructor: "Angel Salazar" },
  { courseId: 1, title: "HTML Básico", description: "Descubre el mundo del código: tu primer paso hacia HTML. Aprende a crear tu primera página web con HTML.", duration: 2, order: 2, difficulty: "Easy", instructor: "Angel Salazar" },
  { courseId: 1, title: "HTML Intermedio", description: "Maneja el uso de enlaces y multimedia para enriquecer tu contenido. Aprende a crear enlaces, imágenes y videos en HTML.", duration: 2, order: 3, difficulty: "Easy", instructor: "Angel Salazar" },
  { courseId: 1, title: "HTML Avanzado", description: "Conoce como crear formularios y mejores prácticas. Aprende a crear formularios y validar datos en HTML.", duration: 2, order: 4, difficulty: "Easy", instructor: "Angel Salazar" },
  { courseId: 1, title: "CSS Básico", description: "Embellece la web con CSS, definiendo estilo y diseño visual. Aplica estilos básicos a tus páginas web.", duration: 2, order: 5, difficulty: "Easy", instructor: "Angel Salazar" },
  { courseId: 1, title: "CSS Intermedio", description: "Diseña sitios web de forma visualmente agradable y coherente. Aprende a usar selectores y propiedades CSS.", duration: 2, order: 6, difficulty: "Easy", instructor: "Angel Salazar" },
  { courseId: 1, title: "CSS Avanzado", description: "Domina transiciones, animaciones, y flexbox. Aprende a crear diseños responsivos y atractivos.", duration: 2, order: 7, difficulty: "Easy", instructor: "Angel Salazar" },
  { courseId: 1, title: "JavaScript Básico", description: "Descubre la magia de la programación con JavaScript. Crea páginas dinámicas e interactivas.", duration: 2, order: 8, difficulty: "Medium", instructor: "Angel Salazar" },
  { courseId: 1, title: "JavaScript Intermedio", description: "Logra que tus sitios web respondan de manera más intuitiva. Aprende a manipular el DOM y eventos.", duration: 2, order: 9, difficulty: "Medium", instructor: "Angel Salazar" },
  { courseId: 1, title: "JavaScript Avanzado", description: "Profundiza en funciones, arrays y objetos para gestionar datos. Descubre como trabajar con funciones avanzadas.", duration: 2, order: 10, difficulty: "Medium", instructor: "Angel Salazar" },
  { courseId: 1, title: "Publicación de tu Página Web", description: "Sube tu página web a internet y comparte el link a tus amigos. Aprende a usar Git, GitHub y Github Pages.", duration: 2, order: 11, difficulty: "Medium", instructor: "Angel Salazar" }
];

// Secciones para el programa de Desarrollo Web
export const webDevSections = [
  { moduleId: 1, title: "Historia de la Computación", content: "Aprenderás sobre la historia de la computación, desde los primeros dispositivos hasta las computadoras modernas.", duration: 30, order: 1 },
  { moduleId: 1, title: "Hardware y Software", content: "Aprenderás sobre los componentes físicos de una computadora y el software que los controla.", duration: 45, order: 2 },
  { moduleId: 1, title: "Sistemas Operativos", content: "Aprenderás sobre los diferentes sistemas operativos y su función en la computación moderna.", duration: 60, order: 3 }
];
